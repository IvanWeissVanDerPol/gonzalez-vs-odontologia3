...
Los hechos del caso y el inventario probatorio. Esta es la base factual sobre la que se construye todo lo demás.
...
- **Legal** (`03-legal/`) usa los hechos como base de la argumentación.
- **Estrategia** (`04-estrategia/`) usa los hechos para definir el plan procesal.
- **Evidencia** (`12-evidencia/`) contiene los originales.
