...
Documentos específicamente para Gabi (no para Carlos). Esta carpeta tiene todo lo que Gabi necesita leer, completar, o consultar para manejar el caso en su día a día.
...
**Solo para Gabi.** Carlos NO necesita leer estos archivos (ya tiene `04-estrategia/91-brief-ejecutivo-carlos.md` y los playbooks).
