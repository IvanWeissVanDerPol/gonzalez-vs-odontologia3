# 08 · Análisis Especializado

Análisis verticales sobre temas técnicos que requieren conocimiento específico: solvencia, odontología, derecho penal, previsional, tributario, administrativo, comparado, proyecto.
...
Cada doc es independiente. Se consultan a demanda según necesidad.

## Conexión con otras carpetas

- **Cuantificación** (`05-cuantificacion/`) usa los análisis previsional, tributario y de solvencia para el cálculo final.
- **Estrategia** (`04-estrategia/`) usa el análisis comparado para reforzar argumentos.
- **Arquitectura del caso** (`11-arquitectura-caso/`) usa el análisis técnico para definir infraestructura.
